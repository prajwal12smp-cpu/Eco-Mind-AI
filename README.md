...
Place project screenshots in a `screenshots/` directory and add them here.
...
```text
screenshots/diagnostic-chat.png
```

### Land Dashboard

```text
screenshots/farm-dashboard.png
```

### Multi-Metric Simulator

```text
screenshots/multi-metric-simulator.png
```

### Scientific RAG Explorer

```text
screenshots/rag-explorer.png
```

### Retrieval Trace

```text
screenshots/retrieval-trace.png
```
